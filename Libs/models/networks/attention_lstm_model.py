"""Attention-LSTM model for time series fatigue life prediction."""
...
class AttentionLayer(nn.Module):
    ...
    def forward(self, lstm_output: torch.Tensor) -> torch.Tensor:
        ...
        Args:
            lstm_output: LSTM outputs of shape [batch_size, seq_len, hidden_dim]
            
        Returns:
            Weighted sum of LSTM outputs of shape [batch_size, hidden_dim]
        """
...
class AttentionLSTMModel(nn.Module):
    """
    LSTM with attention mechanism for time series regression.
    
    Uses LSTM to process sequences and attention to weight important time steps.
    """
    ...
    def __init__(
        ...
        self.attention = AttentionLayer(lstm_hidden_dim, attention_dim)
...
class AttentionLSTMWrapper:
    """Wrapper class for Attention-LSTM model with training and evaluation utilities."""
    ...
    def __init__(
        ...
        """Initialize Attention-LSTM wrapper."""
        self.device = device
