"""GRU model for time series fatigue life prediction."""
...
class GRUModel(nn.Module):
    ...
    Processes multi-sensor time series data to predict RUL.
    """
...
class GRUWrapper:
    """Wrapper class for GRU model with training and evaluation utilities."""
    ...
    def save_model(self, filepath: str):
        ...
        torch.save({
            ...
            'dropout_rate': self.model.gru.dropout if self.model.num_layers > 1 else 0,
